...
// Definir a categoria a ser exibida (Esportes)
$categoria = 'esportes';

// Consulta para buscar as notícias da categoria "Esportes"
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<form action='adicionar_comentario_esportes.php' method='POST' class='form-comentario'>
            ...
            echo "<p>Não há notícias de esportes disponíveis no momento.</p>";
        }
