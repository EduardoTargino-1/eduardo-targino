...
// Definir a categoria a ser exibida (Tecnologia)
$categoria = 'tecnologia';

// Consulta para buscar as notícias da categoria "Tecnologia"
...
<head>
    ...
    <title>Notícias - Tecnologia</title>
    <style>
        /* Estilos gerais */
        body {
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<form action='adicionar_comentario_tecnologia.php' method='POST' class='form-comentario'>
            ...
            echo "<p>Não há notícias de Tecnologia disponíveis no momento.</p>";
        }
