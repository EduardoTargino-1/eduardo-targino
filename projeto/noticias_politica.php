...
// Definir a categoria a ser exibida (Política)
$categoria = 'politica';

// Consulta para buscar as notícias da categoria "Política"
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<form action='adicionar_comentario_politica.php' method='POST' class='form-comentario'>
            ...
            echo "<p>Não há notícias de Política disponíveis no momento.</p>";
        }
