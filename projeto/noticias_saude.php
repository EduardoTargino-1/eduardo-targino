...
// Definir a categoria a ser exibida (Saúde)
$categoria = 'saude';

// Consulta para buscar as notícias da categoria "Saúde"
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<form action='adicionar_comentario_saude.php' method='POST' class='form-comentario'>
            ...
            echo "<p>Não há notícias de Saúde disponíveis no momento.</p>";
        }
